...
if (isset($_POST['add'])) {
    ...
    $ins = insertdata($data, "tbl_category_request");
    set_sweet_alert(1, "New Category Request Added Successfully !");
    move("view.php");
}
?>
<html>
                ...
                <section class="content">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Request Category</h3>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
