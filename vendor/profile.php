...
if (isset($_POST['change'])) {
    ...
    if (get_vendordata('user_password') == $opass) {
        if ($opass == $npass) {
            ...
            if ($npass != $cpass) {
                ...
                $vendor_id = get_vendordata('user_id');
                mysqli_query($connection, "update tbl_user set user_password = '{$cpass}'  where user_id = '{$vendor_id}'");
...
if (isset($_POST['update'])) {
    ...
    $vendor_id = get_vendordata('user_id');
    mysqli_query($connection, "update tbl_user set user_name = '{$user_name}' , user_mobile = '{$user_mobile}', user_email = '{$user_email}' where user_id = '{$vendor_id}'");
                        ...
                        <form method="post" id="form" enctype="multipart/form-data">
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <input type="text" value="<?php echo get_vendordata('user_name') ?>"   required="" class="form-control" name="user_name" placeholder="Enter Your Name">

                                </div><div class="form-group">
                                    <label for="user_email">Email </label>
                                    <input type="email"  value="<?php echo get_vendordata('user_email') ?>"  required="" class="form-control" name="user_email" placeholder="Enter Your Email">

                                </div><div class="form-group">
                                    <label for="user_mobile">Mobile  </label>
                                    <input type="text" value="<?php echo get_vendordata('user_mobile') ?>"  onkeypress="return isNumber(event)"   minlength="10" maxlength="10" required="" class="form-control" name="user_mobile" placeholder="Enter Your Number">
